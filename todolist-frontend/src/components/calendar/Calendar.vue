...
// 节假日数据 - 2025年中国法定节假日
const holidays = ref([
  { date: new Date(2025, 0, 1), title: '元旦', color: '#e74c3c', description: '元旦是公历新年的第一天，即1月1日，是世界多数国家通用的节日。' },
  { date: new Date(2025, 1, 10), title: '春节初一', color: '#e74c3c', description: '春节是中国最重要的传统节日，也是中国人一年当中最隆重、最热闹的一个古老节日。' },
  { date: new Date(2025, 1, 11), title: '春节初二', color: '#e74c3c', description: '春节是中国最重要的传统节日，也是中国人一年当中最隆重、最热闹的一个古老节日。' },
  { date: new Date(2025, 1, 12), title: '春节初三', color: '#e74c3c', description: '春节是中国最重要的传统节日，也是中国人一年当中最隆重、最热闹的一个古老节日。' },
  { date: new Date(2025, 3, 5), title: '清明节', color: '#e74c3c', description: '清明节是中国传统节日，也是最重要的祭祀节日之一，是祭祖和扫墓的日子。' },
  { date: new Date(2025, 4, 1), title: '劳动节', color: '#e74c3c', description: '国际劳动节又称"五一国际劳动节"、"国际示威游行日"，是世界上80多个国家的全国性节日。' },
  { date: new Date(2025, 5, 22), title: '端午节', color: '#e74c3c', description: '端午节是中国民间的传统节日，也是最重要的传统节日之一，已被列入世界非物质文化遗产名录。' },
  { date: new Date(2025, 9, 1), title: '国庆节', color: '#e74c3c', description: '国庆节是中华人民共和国成立的纪念日，定为每年的10月1日。' },
  { date: new Date(2025, 9, 2), title: '国庆节假期', color: '#e74c3c', description: '国庆节是中华人民共和国成立的纪念日，定为每年的10月1日。' },
  { date: new Date(2025, 9, 3), title: '国庆节假期', color: '#e74c3c', description: '国庆节是中华人民共和国成立的纪念日，定为每年的10月1日。' },
  { date: new Date(2025, 9, 4), title: '中秋节', color: '#e74c3c', description: '中秋节是中国的传统节日，也是仅次于春节的第二大传统节日，是家人团圆的象征。' },
]);
